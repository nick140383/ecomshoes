 ...
 */
final class Version20200518111058 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE modele_chaussure ADD cover_image VARCHAR(255) NOT NULL, DROP description');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE modele_chaussure ADD description LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, DROP cover_image');
